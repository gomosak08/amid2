...
specific version of the reCAPTCHA Enterprise V1 API. Most users should consider using
the main client gem,
...
```
$ gem install google-cloud-recaptcha_enterprise-v1
```
...
client library with a name such as `google-cloud-recaptcha_enterprise`,
...
is part of the name, e.g. `google-cloud-recaptcha_enterprise-v1`.
