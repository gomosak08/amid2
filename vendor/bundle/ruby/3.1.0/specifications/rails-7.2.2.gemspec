...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<actionview>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<activemodel>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<activerecord>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<activejob>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<actioncable>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<activestorage>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<actiontext>.freeze, ["= 7.2.2"])
    s.add_runtime_dependency(%q<railties>.freeze, ["= 7.2.2"])
    ...
    s.add_dependency(%q<actionview>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<activemodel>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<activerecord>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<actionmailer>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<activejob>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<actioncable>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<activestorage>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<actionmailbox>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<actiontext>.freeze, ["= 7.2.2"])
    s.add_dependency(%q<railties>.freeze, ["= 7.2.2"])
