class Admin::AppointmentsController < ApplicationController
 ...
 def new
    ...
    # GET /admin/appointments/available_fields
    # Step 2 & 3: show doctor/date form or available‐times form via Turbo Stream
    def available_fields
      ...
      if @doctor_id.present? && @appointment_date.present?
        ...
        target_partial  = "available_times_form"
      else
        @available_times = []
        target_partial  = "doctor_date_form"
      end
      ...
      respond_to do |format|
        format.turbo_stream do
          render turbo_stream: turbo_stream.replace(
            "appointment_form",
            partial: "admin/appointments/#{target_partial}",
            locals: {
    ...
    # Final step: create the record and show confirmation
    def create
