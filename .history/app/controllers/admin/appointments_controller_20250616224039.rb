class Admin::AppointmentsController < ApplicationController
  ...
  # 3) client data (step 4)
  # once the user has picked a time_slot, render the client_data form
...
def create
  ...
  respond_to do |format|
    if @appointment.save
      ...
      format.html { redirect_to admin_appointments_path, notice: "Cita creada" }
    else
